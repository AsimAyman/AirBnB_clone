...
def get_places(city_id):
    ...
    plc = [place.to_dict() for place in city.places]
...
def put_place(place_id):
    ...
    igo = ['id', 'user_id', 'city_id', 'created_at', 'updated_at']
...
def places_search():
    ...
    if dt and len(dt):
        states = dt.get('states', None)
        cities = dt.get('cities', None)
